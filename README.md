...
### Question 4
Arrow function is a short and modern way to write functions in JavaScript. It does the same work as a normal function but the syntax is smaller and cleaner. Instead of writing full function keyword, we use =>.
